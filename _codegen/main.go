...
var (
	pkg       = flag.String("assert-path", "github.com/anthonyLock/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/anthonyLock/testify/_codegen
